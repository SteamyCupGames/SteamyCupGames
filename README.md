...
## 🏛️ Senior Data Engineer | 🏗️ Data Architect | 🎮 Game Developer 

Hi! I’m Néstor, the creator behind **SteamyCup Games**. As a Senior Data Engineer transitioning into **Data Architecture**, I bridge the gap between large-scale data infrastructure, Machine Learning pipelines, and creative software development. My focus lies in designing scalable, cost-optimized, and reliable enterprise data platforms.

Always open to collaborating on **Data Architecture**, **Big Data**, **Machine Learning Infrastructure**, or **Analytics** projects that make a real-world impact. Let’s connect! 🚀
